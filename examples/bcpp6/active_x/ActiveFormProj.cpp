...
USEFORM("ActiveFormImpl.cpp", ActiveFormX); /* TActiveForm: File Type */ /* ChaiX: CoClass */
//---------------------------------------------------------------------------
#pragma package(smart_init)
TComModule  ActiveFormProjModule;
TComModule &_Module = ActiveFormProjModule;
...
BEGIN_OBJECT_MAP(ObjectMap)
  OBJECT_ENTRY(CLSID_ChaiX, TChaiXImpl)
END_OBJECT_MAP()
