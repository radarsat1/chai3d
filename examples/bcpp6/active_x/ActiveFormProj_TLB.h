...
// ************************************************************************ //
#ifndef   ActiveFormProj_TLBH
#define   ActiveFormProj_TLBH
...
// *********************************************************************//
extern "C" const __declspec(selectany) GUID LIBID_ActiveFormProj = {0xF1238B58, 0x47BB, 0x4D14,{ 0xBF, 0xD2, 0x31,0x58, 0x46, 0xC9,0x66, 0xA7} };
extern "C" const __declspec(selectany) GUID IID_IActiveFormX = {0x5E8DF1DA, 0xF743, 0x4937,{ 0xB8, 0x3A, 0xE4,0x13, 0x25, 0x3A,0x1F, 0x44} };
extern "C" const __declspec(selectany) GUID DIID_IActiveFormXEvents = {0x75A861A5, 0x9856, 0x4B54,{ 0xB7, 0xF0, 0x09,0x85, 0x47, 0x4D,0x97, 0xBE} };
extern "C" const __declspec(selectany) GUID CLSID_ChaiX = {0x25949925, 0xCA05, 0x408D,{ 0xAA, 0xA7, 0xDC,0x37, 0xCA, 0xD1,0xC0, 0x38} };
extern "C" const __declspec(selectany) GUID GUID_TxActiveFormBorderStyle = {0xDA500A70, 0x4E46, 0x47FC,{ 0xA0, 0xF0, 0xEA,0x2C, 0x2C, 0xFA,0xAE, 0xB3} };
extern "C" const __declspec(selectany) GUID GUID_TxPrintScale = {0x03C40031, 0x9CE7, 0x4D4C,{ 0xBB, 0x99, 0x22,0xF4, 0xE3, 0x8C,0xEE, 0x1A} };
extern "C" const __declspec(selectany) GUID GUID_TxMouseButton = {0x15105DB7, 0xD1D0, 0x4F62,{ 0x99, 0x04, 0x42,0x68, 0xF6, 0xFD,0xBA, 0x19} };
...
enum      TxPrintScale;
enum      TxMouseButton;
interface DECLSPEC_UUID("{5E8DF1DA-F743-4937-B83A-E413253A1F44}") IActiveFormX;
typedef TComInterface<IActiveFormX, &IID_IActiveFormX> IActiveFormXPtr;

interface DECLSPEC_UUID("{75A861A5-9856-4B54-B7F0-0985474D97BE}") IActiveFormXEvents;
...
// change.                                                                
// *********************************************************************//
typedef IActiveFormX ChaiX;
typedef IActiveFormXPtr ChaiXPtr;

#define LIBID_OF_ChaiX (&LIBID_ActiveFormProj)
...
// GUID:      {5E8DF1DA-F743-4937-B83A-E413253A1F44}
// *********************************************************************//
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE get_AxBorderStyle(Activeformproj_tlb::TxActiveFormBorderStyle* Value/*[out,retval]*/) = 0; // [4]
  virtual HRESULT STDMETHODCALLTYPE set_AxBorderStyle(Activeformproj_tlb::TxActiveFormBorderStyle Value/*[in]*/) = 0; // [4]
  ...
  virtual HRESULT STDMETHODCALLTYPE get_PrintScale(Activeformproj_tlb::TxPrintScale* Value/*[out,retval]*/) = 0; // [8]
  virtual HRESULT STDMETHODCALLTYPE set_PrintScale(Activeformproj_tlb::TxPrintScale Value/*[in]*/) = 0; // [8]
  ...
  Activeformproj_tlb::TxActiveFormBorderStyle __fastcall get_AxBorderStyle(void)
  {
    Activeformproj_tlb::TxActiveFormBorderStyle Value;
    OLECHECK(this->get_AxBorderStyle((Activeformproj_tlb::TxActiveFormBorderStyle*)&Value));
    return Value;
  }
  ...
  Activeformproj_tlb::TxPrintScale __fastcall get_PrintScale(void)
  {
    Activeformproj_tlb::TxPrintScale Value;
    OLECHECK(this->get_PrintScale((Activeformproj_tlb::TxPrintScale*)&Value));
    return Value;
  }
  ...
  __property   Activeformproj_tlb::TxActiveFormBorderStyle AxBorderStyle = {read = get_AxBorderStyle, write = set_AxBorderStyle};
  ...
  __property   Activeformproj_tlb::TxPrintScale PrintScale = {read = get_PrintScale, write = set_PrintScale};
...
// GUID:      {75A861A5-9856-4B54-B7F0-0985474D97BE}
// *********************************************************************//
...
public:
  ...
  HRESULT         __fastcall get_AxBorderStyle(Activeformproj_tlb::TxActiveFormBorderStyle* Value/*[out,retval]*/);
  Activeformproj_tlb::TxActiveFormBorderStyle __fastcall get_AxBorderStyle(void);
  HRESULT         __fastcall set_AxBorderStyle(Activeformproj_tlb::TxActiveFormBorderStyle Value/*[in]*/);
  ...
  HRESULT         __fastcall get_PrintScale(Activeformproj_tlb::TxPrintScale* Value/*[out,retval]*/);
  Activeformproj_tlb::TxPrintScale __fastcall get_PrintScale(void);
  HRESULT         __fastcall set_PrintScale(Activeformproj_tlb::TxPrintScale Value/*[in]*/);
...
public:
  ...
  HRESULT BindDefault()
  {
    return OLECHECK(Bind(CLSID_ChaiX));
  }

  HRESULT BindRunning()
  {
    return BindToActive(CLSID_ChaiX);
  }
...
template <class T> HRESULT __fastcall
TCOMIActiveFormXT<T>::get_AxBorderStyle(Activeformproj_tlb::TxActiveFormBorderStyle* Value/*[out,retval]*/)
{
  return (*this)->get_AxBorderStyle(Value);
}

template <class T> Activeformproj_tlb::TxActiveFormBorderStyle __fastcall
...
template <class T> HRESULT __fastcall
TCOMIActiveFormXT<T>::set_AxBorderStyle(Activeformproj_tlb::TxActiveFormBorderStyle Value/*[in]*/)
{
...
template <class T> HRESULT __fastcall
TCOMIActiveFormXT<T>::get_PrintScale(Activeformproj_tlb::TxPrintScale* Value/*[out,retval]*/)
{
  return (*this)->get_PrintScale(Value);
}

template <class T> Activeformproj_tlb::TxPrintScale __fastcall
...
template <class T> HRESULT __fastcall
TCOMIActiveFormXT<T>::set_PrintScale(Activeformproj_tlb::TxPrintScale Value/*[in]*/)
{
...
template <class T> HRESULT __fastcall
IActiveFormXDispT<T>::get_AxBorderStyle(Activeformproj_tlb::TxActiveFormBorderStyle* Value/*[out,retval]*/)
{
...
{
  Activeformproj_tlb::TxActiveFormBorderStyle Value;
  this->get_AxBorderStyle((Activeformproj_tlb::TxActiveFormBorderStyle*)&Value);
  return Value;
}

template <class T> HRESULT __fastcall
IActiveFormXDispT<T>::set_AxBorderStyle(Activeformproj_tlb::TxActiveFormBorderStyle Value/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("AxBorderStyle"), DISPID(4));
  TAutoArgs<1> _args;
...
template <class T> HRESULT __fastcall
IActiveFormXDispT<T>::get_PrintScale(Activeformproj_tlb::TxPrintScale* Value/*[out,retval]*/)
{
...
{
  Activeformproj_tlb::TxPrintScale Value;
  this->get_PrintScale((Activeformproj_tlb::TxPrintScale*)&Value);
  return Value;
}

template <class T> HRESULT __fastcall
IActiveFormXDispT<T>::set_PrintScale(Activeformproj_tlb::TxPrintScale Value/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("PrintScale"), DISPID(8));
  TAutoArgs<1> _args;
  _args[1] = (int)Value /*[VT_USERDEFINED:0]*/;
...
// *********************************************************************//
template <class T>
class TEvents_ChaiX : public IConnectionPointImpl<T,
...
TEvents_ChaiX<T>::Fire_OnActivate(void)
{
  T * pT = (T*)this;
  pT->Lock();
...
template <class T> void
TEvents_ChaiX<T>::Fire_OnClick(void)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_ChaiX<T>::Fire_OnCreate(void)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_ChaiX<T>::Fire_OnDblClick(void)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_ChaiX<T>::Fire_OnDestroy(void)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_ChaiX<T>::Fire_OnDeactivate(void)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_ChaiX<T>::Fire_OnKeyPress(short* Key)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
template <class T> void
TEvents_ChaiX<T>::Fire_OnPaint(void)
{
  T * pT = (T*)this;
  pT->Lock();
  IUnknown ** pp = m_vec.begin();
...
using  namespace Activeformproj_tlb;
#endif

#pragma option pop

#endif // ActiveFormProj_TLBH
