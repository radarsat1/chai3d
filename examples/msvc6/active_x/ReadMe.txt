========================================================================
		ActiveX Control DLL : ACTIVE_X
========================================================================

ControlWizard has created this project for your ACTIVE_X ActiveX Control
...
that make up your ACTIVE_X ActiveX Control DLL.
...
Active_xCtl.h
	This file contains the declaration of the CActive_xCtrl C++ class.

Active_xCtl.cpp
	This file contains the implementation of the CActive_xCtrl C++ class.

Active_xPpg.h
	This file contains the declaration of the CActive_xPropPage C++ class.

Active_xPpg.cpp
	This file contains the implementation of the CActive_xPropPage C++ class.

Active_xCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CActive_xCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file active_x.rc.
