...
# ADD LINK32 winmm.lib opengl32.lib chai3d_complete.lib glu32.lib PhantomDriver.lib dhdms.lib ode.lib /nologo /subsystem:windows /machine:I386 /nodefaultlib:"msvcprt.lib libc.lib msvcp60.lib" /out:"bin/dynamic_ode.exe" /libpath:"../../../lib/msvc6" /libpath:"../../../external\PhantomDriver\lib\MSVC" /libpath:"lib/ode"
...
# ADD LINK32 winmm.lib opengl32.lib chai3d_complete.lib glu32.lib PhantomDriver.lib dhdms.lib ode.lib /nologo /subsystem:windows /debug /machine:I386 /out:"bin/dynamic_ode.exe" /pdbtype:sept /libpath:"../../../lib/msvc6" /libpath:"../../../external\PhantomDriver\lib\MSVC" /libpath:"lib/ode"
