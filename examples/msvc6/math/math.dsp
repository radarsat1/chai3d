...
# ADD LINK32 winmm.lib chai3d_complete.lib /nologo /subsystem:windows /machine:I386 /nodefaultlib:"msvcprt.lib libc.lib msvcp60.lib" /out:"bin/math.exe" /libpath:"../../../lib/msvc6"
...
# ADD LINK32 winmm.lib chai3d_complete.lib /nologo /subsystem:windows /debug /machine:I386 /out:"bin/math.exe" /pdbtype:sept /libpath:"../../../lib/msvc6"
