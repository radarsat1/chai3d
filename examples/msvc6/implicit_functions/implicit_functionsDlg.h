...
#if !defined(AFX_implicit_functionsDLG_H__DD14893C_4DE3_469B_BE2A_FB588BF46B3B__INCLUDED_)
#define AFX_implicit_functionsDLG_H__DD14893C_4DE3_469B_BE2A_FB588BF46B3B__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif

class Cimplicit_functionsDlg : public CDialog {

public:
	Cimplicit_functionsDlg(CWnd* pParent = NULL);
  HWND m_gl_area_hwnd; 
  int initialized;

// Dialog Data
	//{{AFX_DATA(Cimplicit_functionsDlg)
	enum { IDD = IDD_implicit_functions_DIALOG };
	...
	//{{AFX_VIRTUAL(Cimplicit_functionsDlg)
	protected:
...
protected:
  ...
  // Generated message map functions
	//{{AFX_MSG(Cimplicit_functionsDlg)
...
#endif // !defined(AFX_implicit_functionsDLG_H__DD14893C_4DE3_469B_BE2A_FB588BF46B3B__INCLUDED_)
