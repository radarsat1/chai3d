...
Cforce_shadingDlg::Cforce_shadingDlg(CWnd* pParent /*=NULL*/)
	: CDialog(Cforce_shadingDlg::IDD, pParent) {
	//{{AFX_DATA_INIT(Cforce_shadingDlg)
	//}}AFX_DATA_INIT
  initialized = 0;
...
void Cforce_shadingDlg::DoDataExchange(CDataExchange* pDX) {
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(Cforce_shadingDlg)
	DDX_Control(pDX, IDC_CAMZOOM_SLIDER, m_camera_zoom_slider);
	DDX_Control(pDX, IDC_CHECK1, m_check1);
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(Cforce_shadingDlg, CDialog)
	//{{AFX_MSG_MAP(Cforce_shadingDlg)
	ON_WM_QUERYDRAGICON()
	ON_WM_CLOSE()
  ON_WM_HSCROLL()
	ON_WM_MOUSEMOVE()
...
BOOL Cforce_shadingDlg::OnInitDialog() {
...
HCURSOR Cforce_shadingDlg::OnQueryDragIcon() {
	return (HCURSOR) m_hIcon;
}


void Cforce_shadingDlg::OnClose() {
...
void Cforce_shadingDlg::OnHScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar) {
...
void Cforce_shadingDlg::OnMouseMove(UINT nFlags, CPoint point) {
...
void Cforce_shadingDlg::OnLButtonDown(UINT nFlags, CPoint point) {
...
void Cforce_shadingDlg::OnLButtonUp(UINT nFlags, CPoint point) {
...
void Cforce_shadingDlg::OnRButtonDown(UINT nFlags, CPoint point) {
...
void Cforce_shadingDlg::OnRButtonUp(UINT nFlags, CPoint point) {
...
void Cforce_shadingDlg::OnSizing(UINT fwSide, LPRECT pRect)
{
...
void Cforce_shadingDlg::OnSize(UINT nType, int cx, int cy)
{
...
void Cforce_shadingDlg::OnCheck1() 
{
  g_main_app->setShading(m_check1.GetCheck());	
}
