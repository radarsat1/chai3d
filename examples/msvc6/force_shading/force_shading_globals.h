...
#ifndef _force_shading_GLOBALS_H_
#define _force_shading_GLOBALS_H_

class Cforce_shadingDlg;
class Cforce_shadingApp;
...
SCOPE Cforce_shadingDlg* g_main_dlg;
SCOPE Cforce_shadingApp* g_main_app;
#endif
