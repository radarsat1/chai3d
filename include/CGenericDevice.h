...
//---------------------------------------------------------------------------
//! Purpose:    Read position (px, py, pz) of 3d point contact device.
...
//! Purpose:    Read velocity (vx, vy, vz) of 3d point contact device.
//! iData:      cVector3d type value.
const int   CHAI_CMD_GET_VEL_3D         = 2002;

//! Purpose:    Set a force (fx, fy, fz) to a 3d point contact device.
//! iData:      cVector3d type value.
